...
execute as @a[tag=hell_cauldron_player_alive] store result score @s evg_tmp run data get entity @s Pos[1]
execute as @a[tag=hell_cauldron_player_alive] if score @s evg_tmp < evg_hc_height evg_tmp run tag @s add hell_cauldron_player_dead
