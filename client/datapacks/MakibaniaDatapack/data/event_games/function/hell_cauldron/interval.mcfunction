#function event_games:hell_cauldron/interval
...
#1秒後に回転
execute if score evg_hc_round evg_tmp matches 10 run schedule function event_games:hell_cauldron/rotate_floor 1s
execute if score evg_hc_round evg_tmp matches 15 run schedule function event_games:hell_cauldron/rotate_floor 1s
