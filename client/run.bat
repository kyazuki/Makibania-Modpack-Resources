...
REM "パック設定をダウンロード"
echo パック設定をダウンロード中...
bitsadmin /transfer installer /priority FOREGROUND https://github.com/kyazuki/Makibania-Modpack-Resources/releases/download/v1.2.2/config.yaml "%CD%\config.yaml" > nul
if not %errorlevel% == 0 (
